...
Se puede elegir la política de organización en niveles al crear o editar un volumen en Cloud Manager. Para obtener más información, consulte https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-tiering.html["Documentación de Cloud Manager"].
